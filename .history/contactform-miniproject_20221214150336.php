    ...
    <div class="container">
        ...
        <form method="post">
            <fieldset class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="emai" placeholder="Enter email">
                <small class="text-muted">We'll never share your e-mail with anyone else.</small>
            </fieldset>
              <fieldset class="form-group">
                <label for="email">Email address TO</label>
                <input type="email" class="form-control" id="email" name="emailto" placeholder="Enter to email" multiple>
                <small class="text-muted">We'll never share your e-mail with anyone else.</small>
            </fieldset>
